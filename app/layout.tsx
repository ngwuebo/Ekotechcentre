...
export const metadata: Metadata = {
  ...
  description: 'Premium 4-week live online technology bootcamp for ages 6–14+ with live Zoom classes, coding, robotics, AI, projects, certificate, and WhatsApp support.',
